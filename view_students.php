...
$sql = "SELECT students.Student_ID, students.Full_Name, students.Class , courses.Name FROM students,courses WHERE courses.Course_ID=students.Course_ID ORDER BY students.Student_ID ASC" ;
$result = $conn->query($sql);    
