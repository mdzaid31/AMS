<html>
    ...
    <body>
        <nav class="bg-blue-500 custom-border">
        ...
        <nav class="bg-white custom-border">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
            <a class="flex items-center">
                <img src="logo.png" class="h-12 mr-7"/>
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Bolton Attendance Management System</span>
            </a>
